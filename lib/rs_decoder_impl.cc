...
namespace gr {
  namespace ao40 {
    ...
    rs_decoder::sptr
    rs_decoder::make(bool verbose)
    {
      return gnuradio::get_initial_sptr
        (new rs_decoder_impl(verbose));
    }

    /*
     * The private constructor
     */
    rs_decoder_impl::rs_decoder_impl(bool verbose)
      : gr::block("rs_decoder",
              ...
              gr::io_signature::make(0, 0, 0))
    {
      ...
      set_msg_handler(pmt::mp("in"),
		      boost::bind(&rs_decoder_impl::msg_handler, this, _1));
    }
    ...
    void
    rs_decoder_impl::msg_handler (pmt::pmt_t pmt_msg) {
